...
interface ShareLinksOptions {
  ...
  platforms: ("twitter" | "linkedin" | "bluesky" | "email" | "copy")[]
}

const defaultOptions: ShareLinksOptions = {
  platforms: ["twitter", "linkedin", "bluesky", "email", "copy"],
}

export default ((opts?: Partial<ShareLinksOptions>) => {
  const options: ShareLinksOptions = { ...defaultOptions, ...opts }
  ...
  function ShareLinks({ fileData, displayClass, cfg }: QuartzComponentProps) {
    ...
    return (
      <div class={classNames(displayClass, "share-links")}>
