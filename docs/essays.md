...
Higher education institutions face persistent pressure to demonstrate visible engagement with artificial intelligence, often resulting in what I characterise as "innovation theatre" - the performance of transformation without corresponding structural change. This essay presents a diagnostic framework that distinguishes between performative and structural integration through analysis of four operational domains: governance and accountability, resource architecture, learning systems, and boundary setting. Unlike maturity models that prescribe linear progression, this framework enables institutional leaders to assess whether organisational structures align with stated strategic intentions, revealing gaps between rhetoric and reality. This work is positioned as practitioner pattern recognition requiring subsequent empirical validation, outlining of specific validation pathways, and discussion of the implications for institutional strategy.

[Read more](essays/ai-integration-positioning.md)

## Beyond document management: Graph infrastructure for professional education curricula

Professional education curricula are comprehensively documented but not queryable, forcing staff to manually extract structural information they created. Regulatory compliance reporting consumes weeks; quality assurance requires exhaustive manual verification. We propose graph databases as the source of truth for curriculum structure, with vector databases for semantic search and natural language interfaces. Graph databases enable typed relationship traversal—prerequisite chains, competency mappings, assessment coverage—transforming compliance verification from weeks to hours. This architecture suits AI-forward institutions treating AI integration as ongoing strategic practice requiring active engagement with evolving technologies. The proposal removes technical barriers to interrogating curriculum complexity rather than solving complexity through technology. Technology handles structural verification; educators retain authority over educational meaning-making.
