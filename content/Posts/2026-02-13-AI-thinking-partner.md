...
After the structural revisions, I asked Claude to apply my writing voice to the draft. I have a writing style persona (a description of my analytical patterns and sentence-level habits and preferences that I've built up over time) to see what the paper sounded like in my register rather than in generic academic prose.
...
Other moves required adjustment. The voice persona emphasises analytical commitment, driven by my thinking patterns and tendency to see general patterns in specific instances. In places, Claude had pushed that commitment too far, taking positions more starkly than the evidence warranted. These moments were informative and showed me the line between confident directness and the overreach I needed to avoid. The back-and-forth, iterative nature of the conversation also resulted in refinement to the various personas and other [[documentation-as-infrastructure|structured documentation]] I'm building. That Claude could overreach without embarrassment points to something important about why this kind of collaboration works at all.
