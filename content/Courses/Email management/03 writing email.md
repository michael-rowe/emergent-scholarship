...
Summary: What was once a tool for efficient communication has morphed into a constant stream of interruptions that fragments our attention and erodes our mental head space. By treating email as a deliberate, structured form of writing, we can reclaim our cognitive bandwidth. Writing better emails is about creating structure in an unstructured medium, where very clear email you write helps maintain the collective head space needed for high-value academic work.

Key habits:

Write subject lines that are searchable and actionable

Put required actions in the first paragraph

Break complex messages into numbered points

Delete unnecessary information

Match your writing time to recipient reading time
...
Use the subject line to convey relevant information to the recipient. You could even add an indicator of urgency and deadline so that the recipient - after reading the email once - can act on the subject line alone, without needing to open the email.

The information you include in your subject line should be searchable and scannable (there is more detail on this in the activity below).
...
Student extension request (before)
...
Student extension request (after)
...
Writing center appointments: [Booking link]
...
Here's a streamlined rewrite of the activity section that maintains the professional yet conversational tone:

Activity

Let's put these email principles into practice with two focused exercises.
...
Email is its own genre of writing with specific structural needs. Email isn't just an open canvas for any type of message. While flexible, it works best when you approach it as a distinct form of communication with its own conventions and best practices.

The subject line is crucial for recipient action. A well-crafted subject line should function like a "tweet-able" version of your message - searchable, scannable, and containing enough information for the recipient to understand what action is needed without opening the email.

Keep messages focused and structured for easy processing. Break content into discrete points that can be addressed individually, remove any extraneous information, and put action items at the beginning. The goal is to help recipients quickly understand what they need to do and respond efficiently.
