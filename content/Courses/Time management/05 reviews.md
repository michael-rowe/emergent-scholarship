...
<div class="flip-card">
  <div class="flip-card-inner">
    <div class="flip-card-front">
      <h3>Teaching</h3>
      <p><strong>Common open loops:</strong></p>
      <p>Student email waiting in inbox • Mental note to revise lecture • Meeting notes about curriculum changes • Browser tabs with reading materials • Verbal request for reference letter</p>
    </div>
    <div class="flip-card-back">
      <h3>Closing teaching loops</h3>
      <p><strong>Quick wins (5-15 mins):</strong> Reply to student email • Save reading materials • Create task for reference letter</p>
      <p><strong>Medium tasks (30-60 mins):</strong> Process meeting notes • Schedule time block for lecture revision</p>
      <p><strong>Larger projects:</strong> Add curriculum changes to committee agenda and block 2 hours next week</p>
    </div>
  </div>
</div>
...
<div class="flip-card">
  <div class="flip-card-inner">
    <div class="flip-card-front">
      ...
      <p><strong>Common open loops:</strong></p>
      <p>Draft chapter waiting for feedback • Mental note about conference for student • Meeting notes • Ethics application needing review • Progress report due next month</p>
    </div>
    <div class="flip-card-back">
      <h3>Closing supervision loops</h3>
      <p><strong>Quick wins (5-15 mins):</strong> Send conference details to student • Schedule next supervision meeting • Process meeting notes</p>
      <p><strong>Medium tasks (30-60 mins):</strong> Review ethics application • Begin progress report outline</p>
      <p><strong>Larger projects:</strong> Block 2 hours tomorrow morning for chapter feedback</p>
    </div>
  </div>
</div>
...
<div class="flip-card">
  <div class="flip-card-inner">
    <div class="flip-card-front">
      ...
      <p><strong>Common open loops:</strong></p>
      <p>Committee minutes needing review • Expense claims to process • Strategy document needing input • Calendar invites awaiting response • Budget report requiring updates</p>
    </div>
    <div class="flip-card-back">
      <h3>Closing admin loops</h3>
      <p><strong>Quick wins (5-15 mins):</strong> Respond to calendar invites • Submit expense claims • Review and annotate minutes</p>
      <p><strong>Medium tasks (30-60 mins):</strong> Update budget spreadsheets • Draft input for strategy document</p>
      <p><strong>Larger projects:</strong> Schedule meeting with team leads for strategy feedback</p>
    </div>
  </div>
</div>
...
<div class="flip-card">
  <div class="flip-card-inner">
    <div class="flip-card-front">
      <h3>Research</h3>
      <p><strong>Common open loops:</strong></p>
      <p>Conference notes that might inform methodology • Unfinished draft on desktop • Reviewer comments waiting • Collaborator's email needs follow-up • Data files needing backup</p>
    </div>
    <div class="flip-card-back">
      <h3>Closing research loops</h3>
      <p><strong>Quick wins (5-15 mins):</strong> Move data files to secure storage • Send brief response to collaborator • Create task for reviewer response</p>
      <p><strong>Medium tasks (30-60 mins):</strong> Process conference notes • Organise data files with documentation</p>
      <p><strong>Larger projects:</strong> Block 3 two-hour sessions next week for methods section</p>
    </div>
  </div>
</div>
...
> [!todo]- Develop your weekly review practice
> **Download the template** [link to be added]
>
> **Starting point (30 minutes)**
> - Download the weekly review template
> - Read through each section, noting which elements resonate with your current needs
> - Identify 2-3 areas that would make the biggest difference to your workflow
> - Consider your natural weekly rhythm - when do you typically have energy for reflection?
>
> **Customise your approach (45 minutes)**
> - Choose a quiet time to try a simplified version of the review focusing on your identified priority areas
> - Use the template as a guide rather than a strict checklist
> - Add or modify sections based on your specific academic role and responsibilities
> - Note which parts feel most valuable and which feel like friction
>
> **Test and refine (2 weeks)**
> - Schedule two 90-minute blocks over the next two weeks for your modified review
> - Start with the basics: gathering loose items, processing inputs, and planning ahead
> - Keep notes on what works well and what needs adjustment
> - Pay attention to the impact on your work week - are you feeling more clarity? Less mental overhead?
>
> **Establish your practice (ongoing)**
> - Based on your test period, define your own sustainable review practice
> - Determine your ideal timing (e.g., Friday afternoon, Sunday evening, Monday morning)
> - Decide on your essential elements vs. optional components
> - Create your personalised version of the template
>
> **Remember:**
> - The goal is to create a sustainable practice, not perfect execution
> - Start small and build gradually
> - Adjust the scope based on your energy and available time
> - Focus on what helps you close open loops and create mental space
>
> This activity provides a comprehensive framework, but your weekly review should ultimately reflect your unique needs and constraints. Aim to find a rhythm that helps you maintain a sense of calm productivity without the process becoming another source of pressure.
