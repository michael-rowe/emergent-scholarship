...
> [!tip]- Note on professional identity shifts
...
> [!todo]- Design one structural change (20 minutes)
...
> **Friction point:** "I accept AI summaries without critical evaluation"
> **Structural change:** Create template `evaluation_checklist.md` that appears automatically when saving AI-generated content. Checklist must be completed before file is marked complete:
...
>
> **Friction point:** "I retype context every conversation"
> **Structural change:** Create `00_my_context.md` file. Add keyboard shortcut (Ctrl+Shift+C) that pastes entire context. One keystroke loads context instead of manual retyping.
>
> **Friction point:** "I never document reflections on engagement quality"
> **Structural change:** Add to existing project completion template: "Reflection on AI collaboration in this project: [Was this intellectually productive? Why? What would I do differently next time?]" Reflection happens when completing project documentation you already do.
