...
**What you'll do:** Learn to explore argument structures, test evidence systematically, surface implicit assumptions, and develop judgement about which challenges strengthen versus complicate your thinking

**Progress:** Section 1 of 14
...
- A major assumption you didn't realize you were making is now glaringly obvious
- The structure emphasizes tangential points and buries your strongest evidence
- You realize there's a counterargument you should have anticipated
...
**Progress:** Section 2 of 14

---

## The contrast

Dr. Martinez needs to argue that increased administrative workload decreases research productivity. She opens a document and starts writing: "Universities should recognize that administrative burden..."

Three hours later, she has 2,000 words. Re-reading, she realizes:
...
- Tests whether evidence supports causal claims (realizes she needs to qualify)
...
**3. Did you realize after writing that the structure emphasized the wrong elements?** Yes / No / Partially
...
**✓ You can now recognize when your practice reveals argument problems post-drafting**

**Progress:** Section 4 of 14
...
- Adaptation: Evaluative judgement (recognizing helpful vs unhelpful challenges), contextual judgement (choosing structures that serve goals)

<details> <summary><strong>Understanding the shift (click to expand)</strong></summary>
...
**[Scholar makes deliberate choice]** "I'll use Structure 1 because it meets administrators where they are—they need statistical evidence first. I'm choosing to de-emphasize lived experience in the structure while still including it as confirmation."

**Notice:** The scholar judged structures against specific goals (persuade skeptical administrators), not abstract quality. They recognized what each structure emphasizes and made a deliberate choice about what to foreground.

**Self-explanation:** Why generate three structures when you might already have one in mind?

[Text input box for reasoning]

<details> <summary><strong>Show answer</strong></summary>

Generating alternatives makes structure a conscious choice rather than default. Your first idea might be good, but seeing alternatives reveals what you're emphasizing/de-emphasizing. This lets you choose deliberately based on goals rather than using whatever occurred to you first.
...
**My argument claim:** [___]

**My main evidence:** [___]

**My audience and goals:** [___]

**Now prompt AI:**

"I'm arguing that [claim]. My evidence includes [list]. Suggest three different ways to structure this argument. For each: what it emphasizes, what logical flow it creates, what it might obscure."
...
**Which structure best serves what you need this argument to accomplish?** [___]

**Why does this structure serve your goals?** [___]

**What are you choosing to emphasize?** [___]

**What are you comfortable de-emphasizing?** [___]
...
**✓ You can now explore argument structures deliberately rather than defaulting to first ideas**

**Progress:** Section 6 of 14
...
**Alternative explanations AI suggested:** [___]

**Additional evidence that would help:** [___]
...
[Text box for your approach]

**This introduced unnecessary complexity:** Yes / No

**If yes, why was this unhelpful?** [___]
...
**✓ You can now test whether evidence sufficiently supports claims**

**Progress:** Section 7 of 14
...
<details> <summary><strong>Why "steel man" not "straw man"? (click to expand)</strong></summary>
...
[Text box for your approach and reasoning]
...
**✓ You can now anticipate and address strong counterarguments**

**Progress:** Section 8 of 14
...
### Quick practice: Surface your key assumptions
...
**✓ You can now surface and strategically handle implicit assumptions**

**Progress:** Section 9 of 14
...
<details> <summary><strong>Response A: Accept uncritically</strong></summary>
...
</details> <details> <summary><strong>Response B: Reject defensively</strong></summary>
...
</details> <details> <summary><strong>Response C: Evaluate proportionately</strong></summary>
...
**Learning:** This is evaluative judgement—recognizing the concern is legitimate but deciding how much attention it deserves given your goals, evidence, and audience. Not every concern requires extensive methodological response.
...
For each AI suggestion, decide whether to Accept / Modify / Reject. Explain your reasoning.
...
**AI suggests:** "Your evidence is anecdotal. You need quantitative data and larger sample sizes to make generalizable claims."

**Your decision:** Accept / Modify / Reject

**Your reasoning:** [___]

<details> <summary><strong>Show reasoning</strong></summary>

**Likely: Reject** - AI applied quantitative standards to qualitative work inappropriately. Your epistemological approach values rich description over generalizability. This suggestion misunderstands qualitative research paradigms.
...
If writing for your field: **Modify** by making the assumption explicit briefly without extensive defense (readers share this assumption).
...
**Literacy insight:** Evaluative judgement develops through practice. You learn to recognize patterns: what types of challenges tend to help your thinking, what types tend to complicate unnecessarily, how to distinguish productive from unproductive engagement.

**✓ You can now evaluate whether challenges strengthen or complicate your arguments**

**Progress:** Section 11 of 14
...
**Quick practice:** Rewrite this generic sentence in your analytical voice:
...
**✓ You can now maintain distinctive analytical voice through pre-writing exploration**

**Progress:** Section 12 of 14
...
**Total investment:** 35-40 minutes before writing  
**Result:** Arguments tested before committing to prose
...
- High-stakes claims where reviewers will scrutinize
...
1. [Specific challenge] → Improved because: [___]

**Challenges you rejected:**

1. [Specific challenge] → Rejected because: [___]

**What you learned about your evaluative judgement:**

What types of challenges tend to help your thinking? [___]

What types tend to complicate unnecessarily? [___]

How do you distinguish helpful from unhelpful? [___]

### Process reflection

How did pre-writing exploration differ from drafting first? [___]

What did systematic testing reveal that you might have missed while drafting? [___]

Did AI challenges strengthen your argument or complicate unnecessarily? What helped you judge which was which? [___]

### Pattern recognition (developing evaluative judgement)

After 2-3 argument development sessions, you'll notice patterns:

- You consistently reject certain types of challenges
- You consistently accept certain types of challenges
- You develop intuition about what serves your scholarly work

**This is evaluative judgement developing**—knowing what improves YOUR thinking specifically, not following rules about what AI suggestions to accept.
...
**Specific argument:** [___]

**When:** [___]

**Progress:** Section 14 of 14 — Lesson complete

---

## Key takeaways

### Pre-writing exploration produces stronger arguments faster

Systematic pre-writing thinking produces stronger arguments than drafting first and discovering problems later. Before writing prose, use AI to explore argument structures, test evidence systematically, surface implicit assumptions, and generate steel man objections. This reveals gaps before reviewers find them. When you eventually draft, you're articulating arguments you've already tested through rigorous exploration. This takes 35-40 minutes upfront but prevents hours of structural revision when you realize the argument doesn't work.

### Evaluative judgement distinguishes helpful from unhelpful challenges

Not all AI challenges improve arguments. Some reveal genuine weaknesses requiring attention. Others introduce unnecessary complexity, apply inappropriate standards, or miss your scholarly goals. Evaluative judgement—recognizing which challenges strengthen thinking versus which complicate unnecessarily—is the critical literacy dimension for this lesson. This develops through practice and reflection: document what actually improved your thinking and what didn't help. Over time, you'll recognize patterns about what serves your intellectual work.

### Structure shapes argument fundamentally

The same evidence supports different arguments depending on structure. Most academics default to their first structural idea. Adaptation-level literacy means deliberately exploring alternatives to make conscious choices based on scholarly goals. Generate multiple structural options, evaluate how they handle your evidence, consider audience implications, then choose deliberately. This exploration develops contextual judgement—understanding how structural decisions emphasize different elements and serve different purposes.
...
The next adaptation lesson applies similar literacy dimensions to problem decomposition—using AI to break down complex scholarly challenges systematically. Both lessons emphasize creation/communication (actively constructing understanding), contextual judgement (recognizing what serves goals), and evaluative judgement (distinguishing productive from unproductive engagement).
...
**Share your experience:** How has pre-writing argument development changed your writing process? What role has evaluative judgement played—distinguishing helpful from unhelpful challenges? How do you maintain your distinctive analytical voice whilst engaging with AI's alternative perspectives?