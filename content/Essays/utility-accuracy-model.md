...
description: >-
  Educational support systems often prioritise accuracy over utility, resulting
  in high-quality resources that remain underused. This essay presents a
  mathematical framework demonstrating that AI tutoring systems with moderate
  error rates (10-15%) can achieve superior learning outcomes compared to
  near-perfect alternatives if they significantly increase student engagement.
  Through an 'accessibility paradox,' it shows that imperfect-but-accessible
  systems outperform perfect-but-unused ones. Education's inherent error
  correction mechanisms—practice loops, peer discussion, and instructor
  oversight—make moderate inaccuracy more tolerable than in clinical settings.
  Furthermore, evaluating imperfect AI output develops critical thinking and
  information literacy skills. By shifting the focus from absolute accuracy to
  population-level net benefit, institutions can unlock AI's transformative
  potential. The framework provides quantitative thresholds for acceptable error
  rates, challenging the assumption that educational AI must meet
  diagnostic-level standards. Pragmatic deployment of 'good-enough' AI with
  appropriate safeguards offers a pathway to help millions of students learn
